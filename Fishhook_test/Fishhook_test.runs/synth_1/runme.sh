...
HD_PWD='C:/Users/alceu/Documents/Doutorado/2dof_esc_pole_ila/Fishhook_test/Fishhook_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fishhook_test_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fishhook_test_top_module.tcl
