...
HD_PWD='C:/Users/alceu/Documents/Doutorado/2dof_esc_pole_ila/Fishhook_test/Fishhook_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fishhook_test_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fishhook_test_top_module.tcl -notrace
